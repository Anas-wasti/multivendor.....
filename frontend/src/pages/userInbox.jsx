...
const UserInbox = () => {
  ...
  useEffect(() => {
    const getConversation = async () => {
      if (!user?._id) return; // don’t call until user is loaded
      try {
  ...
  const sendMessageHandler = async (e) => {
    e.preventDefault();
    if (!newMessage.trim()) return; // stop empty text
            ...
            >
              ...
              {item.text !== "" && (
                <div>
                  ...
                  <p className="text-[12px] text-[#000000d3]">
